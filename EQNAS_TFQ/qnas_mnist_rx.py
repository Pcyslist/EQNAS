...
def train_qnn(chromosome_i,i,EPOCHS):
    ...
    model.compile(
        ...
        optimizer=tf.keras.optimizers.SGD(lr=0.08,momentum=0.9,decay=0.0004,nesterov=False),
...
#根据染色体构建量子神经网络
        qnn_results = train_qnn(chromosome[i],i,EPOCHS=6)
...
with open('best_mnist_rx.txt','w') as f:
    f.write("best_acc: \n")
